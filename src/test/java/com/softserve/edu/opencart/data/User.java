...
interface IConfirmPassword {
    ISubscribe setConfirmPassword(String confirmpassword);
}

interface ISubscribe {
	IPrivacypolicy setSubscribe(boolean subscribe);
}

interface IPrivacypolicy {
    IUserBuild setPrivacypolicy(boolean privacypolicy);
}
...
public class User implements IFirstname, ILastname, IEmail, ITelephone, IAddress1, ICity, IPostcode, ICountry, IRegion, IPassword, IConfirmPassword, ISubscribe, IPrivacypolicy, IUserBuild, IUser {
    ...
    */
    ...
    public ISubscribe setConfirmPassword(String confirmpassword) {
        this.confirmpassword = confirmpassword;
        return this;
    }

    public IPrivacypolicy setSubscribe(boolean subscribe) {
        this.subscribe = subscribe;
        return this;
    }
    
    public IUserBuild setPrivacypolicy(boolean privacypolicy) {
